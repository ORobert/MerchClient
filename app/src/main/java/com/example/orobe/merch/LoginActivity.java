        ...
        if (cancel) {
            ...
            try {
				...
				if(user.getUserType()== UserType.Normal) {
					...
					LoginActivity.this.startActivity(mainMenuActivity);
				}else{
					Intent driverActivity = new Intent(this, DriverOrderActivity.class);
					driverActivity.putExtra("user",user);
					LoginActivity.this.startActivity(driverActivity);
				}
